...
<div class="container" x-data="{ rightSide: false, leftSide: false }">
  ...
  <path d="M19 12H5M12 19l-7-7 7-7"/>
    ...
    <div class="logo">WOE MEDİA</div>
    <div class="side-wrapper">
      <div class="side-title">MENU</div>
      <div class="side-menu">
        <a href="mediahome.php">
...
<div class="stories">
<div class="circlee">
  <img class="imgg" src="https://en.gravatar.com/userimage/8283692/4c9d9ec1cd3fd02acb5ac9572e3583da?size=200" alt="" />
  <svg class="svgg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="enable-background:new -580 439 577.9 194;"
     xml:space="preserve">  
    <circle class="circlee" cx="50" cy="50" r="40" />
  </svg>
</div>
<div class="circlee">
  <img class="imgg" src="https://en.gravatar.com/userimage/8283692/4c9d9ec1cd3fd02acb5ac9572e3583da?size=200" alt="" />
  ...
  <svg class="svgg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="enable-background:new -580 439 577.9 194;"
    ...
    <div class="main-container">
      ...
      <div class="timeline">
        ...
        <div class="timeline-right" style="margin-left: 20px;margin-right: 20px;">
          <div class="status box">
            <div class="status-menu">
              <a class="status-menu-item active" href="#">Metin</a>
              <a class="status-menu-item" href="#">Fotoğraf</a>
              <a class="status-menu-item" href="#">Video</a>
            </div>
            <div class="status-main">
              <img src="img/idris.jpg" class="status-img">
              <textarea class="status-textarea" placeholder="Bir Gönderi Yayınla..."></textarea>
            </div>
            <div class="status-actions">
              ...
              <button class="status-share">Paylaş</button>
            </div>
          </div>
          <div class="album box">
            <div class="status-main">
              ...
              <div class="album-detail">
                <div class="album-title"><strong>İdris Akgül</strong></div>
                <div class="album-date">6 Saat Önce</div>
              </div>
...
$users=allusers();
 ...
 echo '  <div class="account">
      <button class="account-button">
       <a href="chat.php" ><svg stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1" viewBox="0 0 24 24">
      ...
      <span class="account-user">'.$adsoyad.'
        <img src="img/'.$user['resim'].'" alt="" class="account-profile" alt="">
        <span>▼</span>
      </span>
    </div> ';
...
foreach ($users as $user) {
   ...
   echo ' <div class="user">';
   if($user["resim"]==null){
    echo ' <img src="assets/img/gallery/images.jpeg" class="user-img">';
  }
  else{
    echo  ' <img   src="img/' . $user["resim"] . '" class="user-img">';
  }

       
    echo '    <div class="username">'.$adsoyad.'
