...
<div class="sidebar pe-0 pb-1 mx-3 my-3" >
            <nav class="navbar bg-secondary navbar-dark " style="background-color:wheat !important;">
                    ...
                    <h3 class="text-primary mx-3" style="color:black !important;">ALANLAR</h3>
               
                <div class="d-flex align-items-center ms-3 mb-2">
                    <div class="position-relative">
                   <a href="palanekle.php"> <img class="rounded-circle" src="img/plus.png" alt="" style="width: 40px; height: 40px;"></a>  
        ...
        <div class="container-fluid pt-4 px-4" >
                <div class="bg-secondary text-center rounded p-4" style="background-color:pink !important;">
                    <div class="d-flex align-items-center justify-content-between mb-4" >
                        <h6 class="mb-0">ALANLAR GRAFİĞİ</h6>
...
$query = $db->query("select * from alanyetenekler ", PDO::FETCH_ASSOC);
...
foreach($dataList as $row){
 echo 
                             '<tr>
                                    ...
                                    <a href="palangüncelle.php?id='.$row["id"].'" class="btn btn-success">Güncelle</a>
                                    
                                    
                                    
                                    </div></td>
                                    <td style="text-align:center;"><div class="btn-group">
                                    <a href="palansil.php?id='.$row["id"].'" class="btn btn-danger">Sil</a>
