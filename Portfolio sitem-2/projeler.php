...
<html lang="en-US">
  ...
  <a href="index.php"><i class="fas fa-home" style="font-size:25px;"></i></a>
...
<div class="wrapperl">
  ...
  <label for="btnl" class="menu-btnl">
      ...
      <i class="fa fa-chevron-circle-left" style="font-size: 25px;" onclick="history.back();"></i>
    </label>
</div>
...
<div class="section px-3 px-lg-2 pt-5" id="projeler">
  <div class="container-narrow">
    ...
    <ul>
        ...
        <li><a href="projeler2.php">2</a></li>
...
<?php   
          $veri=$db->query("select * from projeler limit 6" , PDO::FETCH_ASSOC);
          $verii= $veri->rowCount();
          if ($verii==0) {
