                ...
                <div class="card d-flex mx-auto my-5">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
                            <div class="row">
                                <nav class="nav font-weight-500 mb-1 mb-sm-2 mb-lg-5 px-sm-2 px-lg-5"> <a class="nav-link ac" href="kayıtsürücü.php">Sürücüler</a> <a class="nav-link " href="kayıtotopark.php">Otoparklar</a> </nav>
                            </div>
                            <form onsubmit="event.preventDefault()" name="myform" onsubmit="" class="px-5 pb-5">
                                ...
                                <input type="text" name="userid" placeholder="Ad:">
                                <input type="password" name="passw" placeholder="Soyad:">
                                <input type="tel" name="passw" placeholder="Telefon No:">
                                <input type="tel" name="passw" placeholder="Plaka No:">
                                <input type="password" name="passw" placeholder="Şifre:">
