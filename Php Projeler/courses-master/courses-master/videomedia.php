        ...
        <div class="wrapper">
            <div class="header">
                ...
                <div class="user-settings">
                    <img class="user-img" src="img/idris.jpg" alt="">
                    <div class="user-name">İdris Akgul</div>
            ...
            <div class="main-container">
                <div class="main-header anim" style="--delay: 0s">Popüler</div>
                <div class="main-blogs">
                    <div class="main-blog anim" style="--delay: .1s">
                        <div class="main-blog__title">WORLD OF EDUCATİON Platformunda Ne Tür Eğitim Videoları Var?</div>
                        <div class="main-blog__author">
                            <div class="author-img__wrapper">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
               <path d="M20 6L9 17l-5-5" />
              </svg>
                                <img class="author-img" src="img/idris.jpg" />
                            </div>
                            <div class="author-detail">
                                <div class="author-name" style="color:black;">İdris Akgül</div>
                                <div class="author-info" style="color:black;">53K Görünüm <span class="seperate"></span>2 hafta önce</div>
                            </div>
                        </div>
               ...
               <path d="M20 6L9 17l-5-5" />
                ...
                <div class="small-header anim" style="--delay: .3s">Bilgisayar programcılığı videoları</div>
                <div class="videos">
              ...
              <source src="https://player.vimeo.com/external/436572488.sd.mp4?s=eae5fb490e214deb9ff532dd98d101efe94e7a8b&profile_id=139&oauth2_token_id=57447761" type="video/mp4">
               ...
               <path d="M20 6L9 17l-5-5" />
                        ...
                        <div class="video-by">İdris Akgül</div>
                        <div class="video-name">Php ile Real-Time Chat uygulaması</div>
                        <div class="video-view">54K görme<span class="seperate video-seperate"></span>1 hafta önce</div>
                    </div>
               ...
               <path d="M20 6L9 17l-5-5" />
                ...
                <div class="stream-area">
                    <div class="video-stream">
                        <video id="my_video_1" class="video-js vjs-default-skin anim" width="640px" height="267px" controls preload="none" poster='https://images.unsplash.com/photo-1476801071117-fbc157ae3f01?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDh8fHxlbnwwfHx8&w=1000&q=80'
             ...
             <source src="https://player.vimeo.com/external/390402719.sd.mp4?s=20cfdb066c4253047562b65bd4e411b86a004bc5&profile_id=139&oauth2_token_id=57447761" type='video/webm' />
                 ...
                 Liked
                                ...
                                <div class="video-p-subtitle anim" style="--delay: .3s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus illum tempora consequuntur. Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis earum velit accusantium maiores qui sit quas, laborum voluptatibus
                                    vero quidem tempore facilis voluptate tempora deserunt! </div>
