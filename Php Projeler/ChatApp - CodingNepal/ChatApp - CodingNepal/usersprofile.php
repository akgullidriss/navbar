<?php 
  ...
  $sqll = mysqli_query($conn, "SELECT * FROM users WHERE unique_id = {$_SESSION['unique_id']}");
...
<div class="profile-card">
	...
	<div class="profile-body"><!-- profile body section -->
		<div class="profile-actions">
			...
			<?php echo '<a href="shbt.php?user_id='. $row['unique_id'] .'">	Message </a>';?>
			</button>
			<section class="bio">
...
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <div id="tooltip-settings" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
          ...
          <img src="php/images/<?php echo $roww['img']; ?>" alt="" style="width:30px;height:30px;border-radius:50%">
