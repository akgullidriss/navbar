...
if ($_POST) {
    ...
    if (empty($oran) || empty($resim)) {
        echo '<p class="alert alert-warning">Boş Alan Var</p>';
    }
    else{
$veriekle = $db -> prepare("update alanlar SET oran=?,resim=? where id=$id");
$veriekle ->execute([
...
if ($veriekle) {
    ...
    echo '<p class="alert alert-danger">Güncelleme Başarısız NO.</p>';
...
?>
      ...
      <p class="sign" align="center">Alan Güncelle </p>
      <form class="form1" action="" method="post">
        <input class="un " type="text" align="center" placeholder="<?=$_data["ad"]?>" name="ad" disabled>
        <input class="un " type="text" align="center" value="<?=$_data["resim"]?>" name="resim">
        <input class="pass" type="text" align="center" value="<?=$_data["oran"]?>"  name="oran">
