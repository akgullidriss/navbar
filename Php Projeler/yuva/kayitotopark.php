                ...
                <div class="card d-flex mx-auto my-5">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
                            <div class="row">
                                <nav class="nav font-weight-500 mb-1 mb-sm-2 mb-lg-5 px-sm-2 px-lg-5"> <a class="nav-link" href="kayitsürücü.php">Sürücüler</a> <a class="nav-link ac" href="kayitotopark.php">Otoparklar</a> </nav>
                            </div>
                            <form action="" method="post" name="myform"  class="px-5 pb-5">
...
error_reporting(0);
 ...
 // SQL sorgusu
    $sql = "INSERT INTO otoparklar(otoparkad,otoparksemt,otopark_kodu,otopark_pas,görevliad,görevlisoyad,görevlitel)
     VALUES (:ad,:semt,:kod,:sifre,:gora,:gors,:tel)";
    $stmt = $db->prepare($sql);
    $stmt->bindParam(':ad', $ad);
    $stmt->bindParam(':semt', $semt);
    $stmt->bindParam(':kod', $kod);
    $stmt->bindParam(':sifre', $sifre);
    $stmt->bindParam(':gora', $gora);
    $stmt->bindParam(':gors', $gors);
