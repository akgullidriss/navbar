...
<div class="sidebar pe-0 pb-1 mx-3 my-3" >
            <nav class="navbar bg-secondary navbar-dark " style="background-color:wheat !important;">
                    ...
                    <h3 class="text-primary mx-3" style="color:black !important;">PROJE-EKLE</h3>
...
$veriekle = $db -> prepare("INSERT INTO projeler SET baslik=?,projeicon=?,aciklama=?,aciklama2=?,aciklama3=?,link=?,video=?,resim1=?,resim2=?,resim3=?");
$veriekle ->execute([
$baslik,
$projeicon,
$aciklama,
...
if ($veriekle) {
    ...
    header("REFRESH:2;URL=pprojeekle.php");
}
else {
