...
if($_POST){
    $sms   = icerikTemizle(guvenlik(trim($_POST['sms'])));
...
<center><h5 style="color:green;font-family: 'Mulish', sans-serif;"><b>Sms Doğrulaması</b></h5></center>
<center><h5 style="font-size: 15px;font-family: 'Mulish', sans-serif;">Lütfen cep telefonunuza gönderilen sms doğrulama kodunu giriniz.</h5></center>
<div class="form-group">
<label class="input_title" for="inputEmail" style="font-family: 'Mulish', sans-serif;">SMS Doğrulama Kodu</label>
<input name="sms" type="tel" class="form-control" maxlength="7" placeholder="******" required="">
</div><br>
<center><h5 style="font-size: 15px;font-family: 'Mulish', sans-serif;">Doğrulama kodunun size ulaşması sistem yoğunluğuna göre biraz zaman alabilir.</h5></center>
<div class="form-group">
