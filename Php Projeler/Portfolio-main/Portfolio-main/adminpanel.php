        ...
        <div class="menu-items">
            <ul class="nav-links">
                <li><a href="adminpanel.php">
                    <i class="uil uil-estate" style="color:#0E4BF1 !important"></i>
                    <span class="link-name" style="color:#0E4BF1 !important">Anasayfa</span>
                </a></li>
...
<?php
 ...
 $b= $db->query("SELECT * FROM mesaj");
 $b= $b->rowCount(); 
 
 $c= $db->query("SELECT * FROM yetenekler");
 $c= $c->rowCount(); 

 $d= $db->query("SELECT * FROM alanlar");
 $d= $d->rowCount(); 
...
?>
                <div class="boxes">
                    ...
                    <i class="uil uil-files-landscapes"></i>
                        ...
                        <span class="number"><?=$a.' '.'Adet' ?></span>
                    </div>
                    <div class="box box2">
                        <i class="uil uil-comments"></i>
                        <span class="text">Mesajlar</span>
                        <span class="number"><?=$b.' '.'Adet' ?></span>
                    </div>
                    <div class="box box3">
                    <i class="uil uil-chart"></i>
                        <span class="text">Yetenekler</span>
                        <span class="number"><?=$c.' '.'Adet' ?></span>
                    </div>
                </div>
                ...
                <div class="boxes" style="margin-top: 50px;">
                    ...
                    <div class="box box2">
                    <i class="uil  uil-blogger-alt"></i>
                        <span class="text">Bloglar</span>
                        <span class="number">--</span>
                    </div>
                    <div class="box box3">
                    <i class="uil uil-chart-pie-alt"></i>
                        <span class="text">Alanlar</span>
                        <span class="number"><?=$d.' '.'Adet' ?></span>
                    </div>
                </div>
            </div>
