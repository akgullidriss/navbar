    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <i class="uil uil-comments" style="color:#0E4BF1 !important"></i>
                  
                    <span class="link-name" style="color:#0E4BF1 !important">Mesajlar</span>
                </a></li>
    ...
    $day = date('d/m/y h:s:m', strtotime($dogumTarihi));
          ...
          echo' 
					<tr>
						...
						<td>
                        <a href="mailto:'.$row["email"].'"><p class="text-muted mb-0">'.$row["email"].'</p></a>
						</td>
						<td>'.$row["konu"].'</td>
						<td>'.$row["mesaj"].'</td>
						<td>
                        ...
                        <a href="amesajsil.php?id='.$row["id"].'" class="px-2" id="triggerId2" >
