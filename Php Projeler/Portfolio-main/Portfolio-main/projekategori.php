...
<div class="container my-5" >
  <div class="text-center mb-5" style="margin-top: 100px;">
    ...
    <h1 class="text-capitalize font-weight-bold mt-2"><?=$_data["ad"].' '?><span style="color:#9B5DE5">Projeleri</span></h1>
  </div>
  <div class="row">
  <?php
  $alan=$_data["ad"];
                              $veri=$db->query("select * from projeler where alan='$alan'" , PDO::FETCH_ASSOC);
